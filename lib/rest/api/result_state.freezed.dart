...
class _$ResultStateTearOff {
  ...
  Error<T> error<T>({required NetworkExceptions ne}) {
    return Error<T>(
      ne: ne,
    );
  }
...
mixin _$ResultState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions ne) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(NetworkExceptions ne)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Error<T> implements Error<T> {
  const _$Error({required this.ne});
  ...
  @override
  String toString() {
    return 'ResultState<$T>.error(ne: $ne)';
  }
...
abstract class Error<T> implements ResultState<T> {
  const factory Error({required NetworkExceptions ne}) = _$Error<T>;
